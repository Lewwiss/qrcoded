    ...
    return (
        <div className="bg-black" ref={ref}>
            <div className="mx-auto max-w-7xl flex items-center justify-center py-16 px-10 relative">
                <img src="/images/4.svg" className="absolute -top-96 -left-28 w-96" />
                <img src="/images/5.svg" className="absolute top-0 -left-28 w-96" />
                <img src="/images/6.svg" className="absolute bottom-0 -right-28 w-96" />
                <img src="/images/7.svg" className="absolute -bottom-96 -right-28 w-96" />
